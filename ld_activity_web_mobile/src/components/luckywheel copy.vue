  ...
  <div class="zp-box">
    <div class="turntable" :style="rotateStyle">
      ...
      <div class="prize-item" v-for="(item,index) in prizeList" :key="index"
        :style="`transform: rotate(${-index*360/prizeList.length}deg) translateY(-1.6rem);width:${300 * Math.sin(Math.PI / prizeList.length)/37.5}rem`">
...
<script>
import { luckyitems, setLottery } from '../Api/index'
